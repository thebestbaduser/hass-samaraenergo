...
| `last_reading` | Показания счётчика (сумма по зонам), кВт·ч |
| `last_reading_day` | Показания счётчика (день), кВт·ч |
| `last_reading_night` | Показания счётчика (ночь), кВт·ч |
| `last_reading_semi_peak` | Показания счётчика (полупик), кВт·ч (только для 3-зонного тарифа) |
